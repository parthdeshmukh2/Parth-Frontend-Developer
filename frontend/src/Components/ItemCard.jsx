  ...
  return (
    ...
    >
      ...
      <Box display="flex" flexDirection="column">
        <Text fontSize="xl" fontWeight="400" color="black">
          <b>Name: </b>
          {elem.capsule_id}
        </Text>
        <Text fontSize="xl" fontWeight="400" color="black">
          <b>Launced On:</b> {elem.original_launch}
        </Text>
        <Text fontSize="xl" fontWeight="400" color="black">
        ...
        <Text fontSize="xl" fontWeight="400" color="black">
          <b>Total Landings:</b> {elem.landings}{" "}
        </Text>
      </Box>
      <Button mt="4" bg="red" color="white" onClick={handleModal}>
        Show More
      </Button>
